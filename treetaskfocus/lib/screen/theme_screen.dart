          ...
          children: <Widget>[
            GestureDetector(
              onTap: () => themeProvider.changeTheme(
                  const Color(0xFF00A36C), 'assets/Photo/Spring.gif'),
              child: Container(
            ...
            GestureDetector(
              onTap: () => themeProvider.changeTheme(
                  const Color(0xFF0097b2), 'assets/Photo/raining.gif'),
              child: Container(
                padding: const EdgeInsets.all(8),
            ...
            GestureDetector(
              onTap: () => themeProvider.changeTheme(
                  const Color.fromARGB(255, 233, 130, 13), 'assets/Photo/Autum.gif'),
              child: Container(
                padding: const EdgeInsets.all(8),
            ...
            GestureDetector(
              onTap: () => themeProvider.changeTheme(
                  const Color(0xFF3b525e), 'assets/Photo/Winter.gif'),
              child: Container(
                padding: const EdgeInsets.all(8),
